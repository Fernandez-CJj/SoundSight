...
class _CompositionDetailsScreenState extends State<CompositionDetailsScreen> {
          ...
          Row(
            ...
            children: [
              buildPlaybackButton(
                ...
                onTap: composition.notes.isEmpty ||
                        isDeleting ||
                        isPreparingPlayback
                    ? null
                    : restartComposition,
            ...
            children: [
              Expanded(
                child: buildStatisticCard(
                  ...
                  label: composition.measureCount == 1
                      ? 'Measure'
                      : 'Measures',
      ...
      child: Column(
        children: [
          buildActionRow(
            ...
            onTap: isDeleting || isPlaying ? null : editComposition,
          ),
          ...
          buildActionRow(
            ...
            onTap: isDeleting || isPlaying ? null : deleteComposition,
          ),
        ],
      ),
    );
  ...
  Duration getCompositionDuration(Composition value) {
    ...
    final milliseconds =
        (totalBeats * beatLength * 60000 / value.tempo).round();
